...
async (origineMessage, zk, commandeOptions) => {
  ...
  let isHentaiGroup = await hdb.checkFromHentaiList(origineMessage);

  if (!isHentaiGroup && !superUser) { 
    repondre(`This group is not a group of perverts, calm down my friend.`); 
    return;
  }
